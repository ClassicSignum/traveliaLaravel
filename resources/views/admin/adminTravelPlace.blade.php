                            ...
                            <table class="table table-hover wow flipInX table-dark">
                                    <thead>
                                      <tr >
                                        ...
                                        <th scope="col">Travel Guider Email</th>
                             ...
                             $count =0;
                             ?>
                             @foreach($travelplace as $travelplace) 
                                <?php $count++; ?>
                                  
                                
                                   
                           <form action="" method="post" >
                           <input type="hidden" name="travelplace" value="{{ $travelplace->travelplace }}">

                          
                        
                               <tr>
                                   <th scope="row"><?= $count ?></th>
                                   <td>{{ $travelplace->travelplace }}</td>
                                   <td>{{ $travelplace->location }}</td>
                                   <td>{{ $travelplace->division }}</td>
                                   <td>{{ $travelplace->travelguidermail }}</td>
                                   <td>
                                   <img style="width: 60%;" src="/images/travelplace/{{$travelplace->division}}/{{$travelplace->pictures}}.jpg" alt="">
                                    </td>
                                 
                                
                                   
                                   
                                   <td> <input type="submit" class="btn btn-warning" name="submit" value="delete this"></td>
                                </tr>
                            </form> 
