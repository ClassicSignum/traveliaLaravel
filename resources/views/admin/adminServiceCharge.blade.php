                            ...
                            <tbody>
                             ...
                             @foreach($service as $service) 
                                ...
                                <form action="" method="post">
                                    <input type="hidden" id="email" name="email" value="{{ $service->usermail }}">
                                    <input type="hidden" id="month" name="month" value="{{ $service->paidmonth }}">
                                    
                                    <tr>
                                        <th scope="row"><?=$count ?></th>
                                        <td>{{ $service->usermail }}</td>
                                        
                                    
                                        <td>{{ $service->amount }}</td>

                            
                                        <td>{{ $service->paidmonth }} </td>
                                  ...
                                  <div class=" modal-content">
                                    ...
                                    <div class="modal-body">
                                      <form id="reg_form"  method="post">
                                        ...
                                        <div class="form-group">
                                                <input type="text" name="month"  class="form-control input-sm" placeholder="Charge paid month">
                                                <div class="invalid-feedback">Oops, you missed one fields</div>
                                        </div>

                                        <div class="form-group">
                                            <input type="number" name="amount"  class="form-control input-sm" placeholder="Charge paid amount">
                                            <div class="invalid-feedback">Oops, you missed one fields</div>
                                    </div>
