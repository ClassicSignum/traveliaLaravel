                    ...
                    <div class="items2">
                            ...
                            <table class="table table-hover wow flipInX table-dark">
                                    <thead>
                                      <tr >
                                        <th scope="col">#</th>
                                        <th scope="col">Hotel Emp Email</th>
                           ...
                           <input type="hidden" name="hotelname" value="{{ $hotel->hotelname }}">
                               ...
                               <tr>
                                   ...
                                   <td>
                                       ...
                                       <br>
                                       <br>
                                        <input type="submit" class="btn btn-success" name="submit" value="permit">
                                        <br>
                                        <br>
                                        <input type="submit" class="btn btn-danger" name="submit" value="restrict">
                                    </td>
