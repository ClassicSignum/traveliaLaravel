...
<body>
    ...
    <section class="booking-part" class=" mt-5">
        ...
        <form class="form" action="/traveller/travellerBooking" method="POST">

            <input type="hidden" name="hotelempmail" value="{{ $hotelempmail }}">
            ...
            <div class="form-group mt-5">
                ...
                <select  name="roomtype" id="">
                    ...
                    @foreach(explode(",",$hotelroom) as $roomtype))
            ...
            <div class="form-group">
                ...
                <input type="submit" name="submit" value="apply" class="btn btn-success btn-lg mb-5"
                    id="btnLogin"></input>
            </div>
        </form>
    </section>
