...
<body>
    ...
    <section class="booking-part" class=" mt-5">

        <form class="form"  class="mt-2 mb-3" action="" method="POST">

                <label for="">Hotel Emp Email</label>
                <input type="text" readonly class=" form-control" name="hotelempmail" value="{{$bookinginfo[1]}}">
                <label for="">Hotel Name</label>
                <input type="text" readonly class=" form-control" name="hotelname" value="{{$bookinginfo[2]}}">
               
                <label for="">Checkin</label>
                <input type="text" readonly class=" form-control" name="checkin" value="{{$bookinginfo[3]}}">
                
                <label for="">Checkout</label>
                <input type="text" readonly class=" form-control" name="checkout" value="{{$bookinginfo[4]}}">
                <label for="">Total days</label>
                <input type="text" readonly class=" form-control" name="totaldays" value="{{$bookinginfo[5]}}">
                <label for="">Total cost</label>
                <input type="text" readonly class=" form-control" name="totalcost" value="{{$bookinginfo[7]}}">
                <label for="">Room type</label>
                <input type="text" readonly class=" form-control" name="roomtype" value="{{$bookinginfo[6]}}">
                <input type="submit" class="btn btn-info mt-3 mb-3" name="submit" value="submit">
